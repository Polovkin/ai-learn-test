...
server.registerTool("list_directory", {
    description: "List files and directories inside the project. Use this before reading files when the location is unknown.",
    inputSchema: z.object({
...
server.registerTool("read_file", {
    description: "Read a text file from the project. Always use list_directory first if the exact path is unknown.",
    inputSchema: z.object({
        path: z.string(),
    }),
}, async ({ path: requestedPath }) => {
